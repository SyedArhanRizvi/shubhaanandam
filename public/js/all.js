(function($){
   ...
   /* --------------------------------------------
    ...
    function init_classic_menu(){    
        ...
        } else if (!($(".main-nav").hasClass("white"))){
    ...
    (function($){
        ...
        $(".testimonials-slider-3").owlCarousel({
            ...
            navigationText: [
                ...
                '<span class="visually-hidden">Previous Slide</span><img src="./images/icons/left-arrow.png" class="kcmscsocc" width="20px">',

                '<span class="visually-hidden">Next Slide</span><img src="./images/icons/right-arrow-black.png" class="kcmscsocc" width="20px">'
