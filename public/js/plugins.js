...
!(function (e) {
    ...
    (h.prototype = {
        ...
        updateItemHTML: function () {
            ...
            t.appendContent(r, i), (n.preloaded = !0), b(u, n), (o = n.type), t.container.prepend(t.contentContainer), b("AfterChange");
        },
        ...
        _checkIfClose: function (n) {
            if (!e(n).hasClass(g)) {
                ...
                if ((i && o) || !t.content || e(n).hasClass("mfp-close") || (t.preloader && n === t.preloader[0])) return !0;
            ...
            getInline: function (n, i) {
                if ((S(), n.src)) {
                    ...
                    if (a.length) {
                        ...
                        r && r.tagName && (T || ((T = w((k = o.hiddenClass))), (k = "mfp-" + k)), (E = a.after(T).detach().removeClass(k))), t.updateStatus("ready");
    ...
    e.magnificPopup.registerModule(O, {
        ...
        proto: {
            initAjax: function () {
                t.types.push(O), (P = t.st.ajax.cursor), C(s + "." + O, M), C("BeforeChange." + O, M);
            },
            getAjax: function (n) {
                ...
                var i = e.extend(
                    {
                        ...
                        error: function () {
                            z(), (n.finished = n.loadError = !0), t.updateStatus("error", t.st.ajax.tError.replace("%url%", n.src));
                        },
                    },
                    t.st.ajax.settings
                );
        ...
        proto: {
            initImage: function () {
                ...
                t.types.push("image"),
                    ...
                    C(s + i, function () {
                        n.cursor && e(document.body).removeClass(n.cursor), y.off("resize" + p);
                    }),
                    ...
                    o = function (a) {
                        B && clearInterval(B),
                            (B = setInterval(function () {
                                return i.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(B), void (3 == ++n ? o(10) : 40 === n ? o(50) : 100 === n && o(500)));
                            }, a));
                    };
                o(1);
            },
            getImage: function (n, i) {
                ...
                return (
                    ...
                    t.resizeImage(),
                    n.hasSize
                        ? (B && clearInterval(B), n.loadError ? (i.addClass("mfp-loading"), t.updateStatus("error", s.tError.replace("%url%", n.src))) : (i.removeClass("mfp-loading"), t.updateStatus("ready")), i)
        ...
        e.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function (n) {
                    ...
                    var s = { width: i.width(), height: (v ? i.innerHeight() : i[0].offsetHeight) - r - a };
                    return void 0 === F && (F = void 0 !== document.createElement("p").style.MozTransform), F ? (s["-moz-transform"] = s.transform = "translate(" + o.left + "px," + o.top + "px)") : ((s.left = o.left), (s.top = o.top)), s;
                },
            },
        });
    var L = "iframe",
                        ...
                        C("BuildControls" + o, function () {
                            if (t.items.length > 1 && n.arrows && !t.arrowLeft) {
                                ...
                                o[s](function () {
                                    ...
                                    t.isIE7 && (w("b", o[0], !1, !0), w("a", o[0], !1, !0), w("b", a[0], !1, !0), w("a", a[0], !1, !0)),
                        ...
                        (a = !1),
                            ...
                            y
                                .on("touchmove" + Z, function (e) {
                                    (s = (r = e.originalEvent ? e.originalEvent.touches : e.touches).length), (r = r[0]), (Math.abs(r.clientX - i) > 10 || Math.abs(r.clientY - o) > 10) && ((a = !0), R());
                                })
    ...
    (jQuery.mbYTPlayer = {
        ...
        buildPlayer: function (options) {
            if (ytp.YTAPIReady || void 0 !== window.YT)
                ...
                jQuery("#YTAPI").remove();
                let e = jQuery("<script>").attr({ src: "//www.youtube.com/iframe_api?v=" + jQuery.mbYTPlayer.version, id: "YTAPI", async: "async", defer: !0 });
        ...
        getDataFromAPI: function (e) {
            (e.videoData = jQuery.mbStorage.get("YTPlayer_data_" + e.videoID)),
                e.videoData
                    ...
                    ? jQuery
                          .getJSON("https://www.googleapis.com/youtube/v3/videos?id=" + e.videoID + "&key=" + jQuery.mbYTPlayer.apiKey + "&part=snippet", function (r) {
                              e.dataReceived = !0;
        ...
        changeCoverImage: function (e) {
            ...
            if (r.opt.coverImage || r.orig_containment_background) {
                ...
                t && r.opt.containment.css({ background: t, backgroundSize: "cover", backgroundRepeat: "no-repeat", backgroundAttachment: "fixed" });
            }
            return this;
        },
        ...
        normalizeCss: function (e) {
            ...
            r)) {
                if (
                    ...
                    "filter" !== t || jQuery.mbBrowser.mozilla || ((r[jQuery.CSS.sfx + "filter"] = e[t]), delete r[t]),
            ...
            updateSliderVal: function (r) {
                ...
                if (t.opt) {
                    ...
                    (t.x = "object" == typeof r ? r.clientX + document.body.scrollLeft - this.offset().left : "number" == typeof r ? (r * a) / t.opt.maxval : (t.opt.initialval * a) / t.opt.maxval),
                        ...
                        (t.lastVal === t.value && (("h" === t.opt.orientation && (t.x >= this.outerWidth() || 0 >= t.x)) || ("h" !== t.opt.orientation && (t.y >= this.outerHeight() || 0 >= t.y)))) ||
