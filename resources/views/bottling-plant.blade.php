                    ...
                    <div class="row">
                        <div class="col-md-8 offset-md-2">
                            ...
                            <div class="mt-n10 wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1.2s">
                                <h6>For The Any Further Enquiry</h6>
                                <div class="d-inline-flex mt-10 mx-3">
                                    <div class="features-list-icon">
                                        <img src="images/social-icon/phone-call.png" width="15px" />
                                    </div>
                                    <div class="features-list-text">
                                        Call : +91 836 805 6652
                                    </div>
                                </div>
                                <div class="d-inline-flex mt-10 mx-3">
                                    <div class="features-list-icon">
                                        <img src="images/social-icon/whatsapp.png" width="15px" />
                                    </div>
                                    <div class="features-list-text">
                                        What'sapp : +91 836 805 6652
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row g-0">
                    ...
                    <div class="split-column-right rounded-0  position-relative d-flex align-items-center">
                        ...
                        <div class="wow fadeInUp">
                            <h2 class="section-title mb-30">
                               A High-Capacity Industrial Facility by Shubh Anandam
                            </h2>

                            <p class="mb-50">
                              As part of its diversified real estate ventures, Shubh Anandam has successfully developed a state-of-the-art Bottling Plant in Jharkhand, strengthening the region’s industrial infrastructure. This facility represents our commitment to contributing to India's manufacturing and supply ecosystem.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6 d-flex align-items-stretch order-lg-first">
                    <div class="split-image-left rounded-0">
                        <img src="images/full-width-images/shubha__retouch__76124.png" alt="Image Description" />
                    </div>
                </div>
            </div>
        </section>
</br>
        <section class="page-section bg-scroll light-content" style="background-image: url(images/project/anandam_floor/A67A4025.JPG);">
            <!-- Desktop Overlay -->
            ...
            <div class="container position-relative">
                <div class="row wow fadeInUp">
                    <div class="col-md-7 offset-md-5 col-lg-6 offset-lg-6 col-xl-5 offset-xl-7">
                        <h2 class="section-title mb-40 mb-sm-30">Project Highlights</h2>
                        <div class="row dsvsdvds">
                            <div class="col-md-12">
                                <div class="bo-area-intet">
                                    <h5>Project Type</h5>
                                    <p>Industrial Bottling Facility</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="bo-area-intet">
                                    <h5>Location</h5>
                                    <p>Strategically located in Jharkhand with excellent logistical connectivity</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="bo-area-intet">
                                    <h5>Facility Specs</h5>
                                    <p>High-capacity production lines with modern automation</p>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="bo-area-intet">
                                    <h5>Usage</h5>
                                    <p>Packaged beverages and consumables
                            ...
                            <div class="col-md-12">
                                <div class="bo-area-intet">
                                    <h5>Compliance</h5>
                                    <p>Built with full adherence to safety, environmental, and industry standards
            ...
            <div class="container position-relative">
                ...
                <div class="row mb-60 mb-xs-30">
                    <div class="col-md-12">
                        ...
                        <h3 class="section-title mb-0 text-center"><span class="wow charsAnimIn" data-splitting="chars">Industrial Impact</span></h3>
                    </div>
                </div>
                <div class="row www-bo-dwd">
                    <div class="col-md-12 col-lg-12 align-items-stretch mb-sm-30 text-center">
                   <p>This facility not only supports large-scale production and distribution but also creates local employment opportunities and fosters economic growth in the region. With advanced technology and efficient design, it stands as a benchmark in industrial construction.</p>
                    </div>
